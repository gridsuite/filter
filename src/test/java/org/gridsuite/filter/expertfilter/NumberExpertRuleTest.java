...
class NumberExpertRuleTest {
    ...
    private static Stream<Arguments> provideArgumentsForVoltageLevelTest() {
        ...
        return Stream.of(
            ...
            Arguments.of(EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, true),
            Arguments.of(EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 2.0, null, voltageLevel, false),
            Arguments.of(EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 4.0, null, voltageLevel, true),
            Arguments.of(EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 3.0, null, voltageLevel, false),
            ...
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 0.0, null, voltageLevel, true),
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, true),
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 2.0, null, voltageLevel, false),
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 3.0, null, voltageLevel, true),
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 4.0, null, voltageLevel, true),
            Arguments.of(GREATER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 5.0, null, voltageLevel, false),
            ...
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 0.0, null, voltageLevel, true),
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, false),
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 2.0, null, voltageLevel, false),
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 3.0, null, voltageLevel, true),
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 4.0, null, voltageLevel, false),
            Arguments.of(GREATER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 5.0, null, voltageLevel, false),
            ...
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 2.0, null, voltageLevel, true),
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, true),
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 0.0, null, voltageLevel, false),
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 5.0, null, voltageLevel, true),
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 4.0, null, voltageLevel, true),
            Arguments.of(LOWER_OR_EQUALS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 3.0, null, voltageLevel, false),
            ...
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 2.0, null, voltageLevel, true),
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, false),
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, 1.0, null, voltageLevel, false),
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 5.0, null, voltageLevel, true),
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 4.0, null, voltageLevel, false),
            Arguments.of(LOWER, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, 3.0, null, voltageLevel, false),
            ...
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(0.0, 2.0), voltageLevel, true),
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(2.0, 6.0), voltageLevel, false),
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(3.0, 4.0), voltageLevel, false),
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(3.0, 5.0), voltageLevel, true),
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(5.0, 6.0), voltageLevel, false),
            Arguments.of(BETWEEN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(2.0, 3.0), voltageLevel, false),
            ...
            Arguments.of(EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, null, voltageLevel, true),
            Arguments.of(EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, null, voltageLevel1, false),
            Arguments.of(EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, null, voltageLevel, true),
            Arguments.of(EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, null, voltageLevel1, false),
            ...
            Arguments.of(NOT_EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, null, voltageLevel, false),
            Arguments.of(NOT_EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, null, voltageLevel1, true),
            Arguments.of(NOT_EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, null, voltageLevel, false),
            Arguments.of(NOT_EXISTS, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, null, voltageLevel1, true),
            ...
            Arguments.of(IN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(1.0, 4.0, 5.0), voltageLevel, true),
            Arguments.of(IN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(3.0, 5.0), voltageLevel, false),
            Arguments.of(IN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(1.0, 4.0, 5.0), voltageLevel, true),
            Arguments.of(IN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(3.0, 5.0), voltageLevel, false),
            ...
            Arguments.of(NOT_IN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(3.0, 5.0), voltageLevel, true),
            Arguments.of(NOT_IN, FieldType.SHORT_CIRCUIT_CURRENT_LOW_LIMIT, null, Set.of(1.0, 4.0, 5.0), voltageLevel, false),
            Arguments.of(NOT_IN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(3.0, 5.0), voltageLevel, true),
            Arguments.of(NOT_IN, FieldType.SHORT_CIRCUIT_CURRENT_HIGH_LIMIT, null, Set.of(1.0, 4.0, 5.0), voltageLevel, false)
        );
    }
